...
[![Версия](https://img.shields.io/badge/version-1.7.4-green.svg)](server/package.json)
...
`compose.yml` собирает `obsync-server:1.7.4` из `./server` и запускает PostgreSQL 16.
