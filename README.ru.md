...
[![Версия](https://img.shields.io/badge/version-1.6.25-green.svg)](server/package.json)
...
`compose.yml` собирает `obsync-server:1.6.25` из `./server` и запускает PostgreSQL 16.
