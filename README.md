...
[![Version](https://img.shields.io/badge/version-1.7.4-green.svg)](server/package.json)
...
`compose.yml` builds `obsync-server:1.7.4` from `./server` and starts PostgreSQL 16.
