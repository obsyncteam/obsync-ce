...
[![Version](https://img.shields.io/badge/version-1.6.20-green.svg)](server/package.json)
...
`compose.yml` builds `obsync-server:1.6.20` from `./server` and starts PostgreSQL 16.
